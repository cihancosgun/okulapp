...
okulappDb.formFields.insert({crudFormCode: "formFields", fieldName: "controllClassName", name: "controllClassName", label: "Form Nesnesi", labelEn: "Form Controller", required: true, controllClassName: "InputSelectOneFormControl", defaultValue: null,
    items: ["InputTextFormControl", "InputCheckBoxControl", "InputDateFormControl", "InputDoubleFormControl", "InputIntegerFormControl", "InputMaskFormControl", "InputSelectOneDbFormControl", "InputSelectOneFormControl", "InputSelectManyDbFormControl", "InputSelectManyFormControl", "InputCodeMirrorFormControl", "InputImage"], order: NumberInt(7)});
